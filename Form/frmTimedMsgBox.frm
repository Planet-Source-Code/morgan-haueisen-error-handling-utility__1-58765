...
Private Declare Function LoadStandardIcon Lib "user32" _
      ...
      ByVal lpIconNum As enuSystemIconConstants) As Long
...
Private Declare Function GradientFillTriangle Lib "msimg32" _
      ...
      ByRef pMesh As GRADIENT_TRIANGLE, _
...
Err_Proc:
   Err_Handler True, Err.Number, Err.Description, "frmMsgBox", "GradientFill"
   Err.Clear
   Resume Exit_Proc
...
Err_Proc:
   Err_Handler True, Err.Number, Err.Description, "frmMsgBox", "GradientFillColor"
   Err.Clear
   Resume Exit_Proc
...
Err_Proc:
   Err_Handler True, Err.Number, Err.Description, "frmMsgBox", "LoadShell32Icon"
   Err.Clear
   Resume Exit_Proc
...
Err_Proc:
   Err_Handler True, Err.Number, Err.Description, "frmMsgBox", "PositionForm"
   Err.Clear
   Resume Exit_Proc
...
Err_Proc:
   Err_Handler True, Err.Number, Err.Description, "frmMsgBox", "SInputBox"
   Err.Clear
   Resume Exit_Proc
...
Err_Proc:
   Err_Handler True, Err.Number, Err.Description, "frmMsgBox", "tmrCountDown_Timer"
   Err.Clear
   Resume Exit_Proc
