...
Public Function AddNode(ByVal vstrParent As String, _
                        ...
                        Optional ByVal vblnIsSorted As Boolean = True) As Long
...
Err_Proc:
   Err_Handler True, Err.Number, Err.Description, "modTreeView", "MakeUniqueKey"
   Err.Clear
   Resume Exit_Proc
...
Public Sub SetDefaultTree()
  ...
  Dim NodX As MSComctlLib.Node
   ...
   With mtvwObjTrv
      ...
      'AddNode "Project", "Dependencies", "Dependencies", , "FOLDER", False, False
      AddNode "Project", "Forms", "Forms", , "FOLDER", , True
      AddNode "Project", "Modules", "Modules", , "FOLDER", , True
      AddNode "Project", "Classes", "Classes", , "FOLDER", , True
      AddNode "Project", "User controls", "User controls", , "FOLDER", , True
      AddNode "Project", "User documents", "User documents", , "FOLDER", , True
      AddNode "Project", "Designer", "Designer", , "FOLDER", , True
